...
class DataManager(object):
    ...
    def _load_fer2013(self):
        ...
        taken_out_data = data.loc[(data.emotion > 1)]
        pixels = taken_out_data['pixels'].tolist()
        width, height = 48, 48
        faces = []
        ...
        emotions = pd.get_dummies(taken_out_data['emotion']).as_matrix()
...
#               4:'Sad',5:'Surprise',6:'Neutral'}
        return {0:'Unhappy',1:'Neutral',2:'Neutral',3:'Happy',
                4:'Neutral',5:'Happy',6:'Neutral'}                
        # return {0:'fear',1:'happy',2:'sad',3:'surprise',
               # 4:'neutral'}
